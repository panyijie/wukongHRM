...
class UserViewModel extends ViewModel{
	public $viewFields = array(
		'user'=>array('user_id','position_id','name'=>'name','password','annual_leave','annual_leave_reset','salt','status','type','work_status','category_id', 'sex', 'address', 'email', 'telephone', 'working_shift_id', 'hr_supervisor', '_type'=>'LEFT'),
