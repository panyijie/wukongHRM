...
<html lang="zh-CN">
	...
	<div id="wrap" style="padding:0px;">
		<div class="login-logo"><img src="<?php echo C('defaultinfo.logo');?>"></div>
		<div class="login-bg"></div>
		<div class="login-box">
			<div class="login-main">
				<form class="form-signin" role="form" action="<?php echo U('core/user/login');?>" method="post" >
					<h2><?php echo C('defaultinfo.name');?>登陆</h2>
					...
					<p><button class="btn btn-primary" type="submit">登陆</button></p>
				</form>
				<div class="footer">
					<p class="text-muted credit">
						悟空HRM © 2013--<?php echo date('Y');?>
					</p><p class="text-muted credit">
						郑州卡卡罗特软件科技有限公司
					</p>
				</div>
			</div>
