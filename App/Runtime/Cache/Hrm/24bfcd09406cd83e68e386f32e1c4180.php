...
<div class="body-right">
	<div class="row-table">
		<div class="row-table-title">培训计划</div>
		<div class="row-table-body">
			<p class="form-title"><a class="pull-right btn btn-primary btn-xs" href='<?php echo U("hrm/train/add");?>'>新建计划</a>计划列表</p>
			<table class="table" style="margin-bottom:0px;">
				<form action="<?php echo U('hrm/train/delete');?>" method="post">
				<tbody>
					<tr>
					...
					<?php if(is_array($trainlist)): $i = 0; $__LIST__ = $trainlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td><input type="checkbox" name="train_id[]" value="<?php echo ($vo["train_id"]); ?>" class="check_list"></td>
						<td><a href="<?php echo U('hrm/train/view','id='.$vo['train_id']);?>"><?php echo ($vo["name"]); ?></a></td>
						...
						<td><?php if($vo['change'] == 1): ?>已转<?php else: ?>未转<?php endif; ?></td>
						<td><a href="<?php echo U('hrm/train/edit','id='.$vo['train_id']);?>">编辑</a>&nbsp;|&nbsp;<a href="<?php echo U('hrm/train/delete','id='.$vo['train_id']);?>">删除</a></td>
					</tr><?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
				<tfoot>
					<tr>
						<td><input type="submit" value="删除" class="btn btn-primary btn-xs"></td>
						<td colspan="11"><?php echo ($page); ?><div class="clear"></div></td>
					</tr>
				</tfoot>
				</form>
			</table>
