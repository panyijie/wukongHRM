...
<div class="body-right">
	<div class="row-table">
		<div class="row-table-title">添加加班类型</div>
		<div class="row-table-body">
			<form class="form-horizontal " action="<?php echo U('hrm/overtime/addcategory');?>" method="post">
				<p class="form-title">添加加班类型&nbsp;&nbsp;<a href="javascript:history.go(-1);">返回</a>&nbsp;&nbsp;<a href="<?php echo U('hrm/overtime/category');?>">返回上级</a></p>
				...
				<div class="form-group">
					<label for="name" class="col-sm-2 control-label">加班费</label>
					<div class="col-sm-3">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<textarea name="description" class="col-sm-8 form-control" style="min-height:150px;"></textarea>
					</div>
				</div>
				<div class="form-group">
