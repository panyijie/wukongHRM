...
<div class="body-right">
	<div class="row-table">
		...
		<div class="row-table-body">
			<form class="form-horizontal " action="<?php echo U('hrm/structure/addposition');?>" method="post">
				<p class="form-title">
				<a class="pull-right btn btn-primary btn-xs" href="<?php echo U('hrm/structure/position');?>">岗位列表</a>
				添加岗位</p>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php if(is_array($position_list)): $i = 0; $__LIST__ = $position_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["position_id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
					</div>
				</div>
				<div class="form-group">
