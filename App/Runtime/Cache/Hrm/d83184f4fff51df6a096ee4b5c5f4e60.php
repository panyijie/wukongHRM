		...
		<div class="row-table-body">
			<form class="form-horizontal " action="<?php echo U('hrm/leave/add');?>" method="post">
				<p class="form-title">
                    ...
                    <?php if(true == $isSubUser and '0' == $leave['status']): ?><a href="javascript:void(0);" id="leave_pass" class="pull-right btn btn-primary btn-xs viewBtn">审核通过</a>
                        <a href="javascript:void(0);" id="leave_fail" class="pull-right btn btn-primary btn-xs viewBtn" >审核不通过</a><?php endif; ?>
				</p>
