...
<div class="body-right">
	<div class="row-table">
		<div class="row-table-title">添加模板类型</div>
		<div class="row-table-body">
			<form class="form-horizontal " action="<?php echo U('hrm/appraisaltemplate/addcategory');?>" method="post">
				<p class="form-title">添加模板类型&nbsp;&nbsp;<a href="javascript:history.go(-1);">返回</a></p>
